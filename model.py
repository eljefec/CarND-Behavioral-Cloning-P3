...
def train_model(model_id, capture_root, steering_correction):
    print('Train model. id=[{}], capture_root=[{}], steering_correction=[{}]'.format(model_id, capture_root, steering_correction))
    ...
    model_filename = 'model-{}-{}-corr{}.h5'.format(model_name, model_id, steering_correction)
...
for steering_correction in range(10, 15):
    train_model(args.id, 'e:\\capture-data', steering_correction / 100)
